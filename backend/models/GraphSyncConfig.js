...
const graphSyncConfigSchema = new mongoose.Schema(
  {
    ...
    pendingDeviceCode: { type: String, default: '' },
    pendingDeviceCodeRequestedBy: { type: String, default: '' },
    pendingDeviceCodeExpiresAt: { type: Date, default: null },
    pendingDeviceCodeCreatedAt: { type: Date, default: null },
