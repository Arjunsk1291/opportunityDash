...
import { registerUpcomingRoutes } from './routes/upcomingRoutes.js';
...
registerUpcomingRoutes(app, { UpcomingFeature, verifyToken, isDatabaseReady, respondDatabaseUnavailable, isMasterOrAdmin, mapIdField });
