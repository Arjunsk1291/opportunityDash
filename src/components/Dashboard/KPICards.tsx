...
export function KPICards({ stats, onKPIClick }: KPICardsProps) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-10 gap-2 sm:gap-3 md:gap-4">
      {kpis.map((kpi, index) => (
        <Card 
          key={kpi.label} 
        ...
        >
          <div className="flex flex-col items-start gap-1.5 sm:gap-2">
            ...
            <div className="min-w-0 w-full">
              ...
              <p className={`text-sm sm:text-base font-bold ${kpi.color} break-words`}>
                {kpi.isCurrency ? (
