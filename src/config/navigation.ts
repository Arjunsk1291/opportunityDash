...
export const PAGE_GROUPS: Array<{ label: string; pages: PageKey[] }> = [
  ...
  { label: 'Master Panel', pages: ['handover', 'master', 'master_general', 'master_users', 'master_data_sync', 'master_telecast', 'master_update', 'master_export'] },
];
...
export const NAV_ITEMS = [
  ...
  { title: 'Handover', url: '/handover', pageKey: 'handover' as const, icon: Sparkles, section: 'admin' as const },
